        ...
        <div class="box box-primary border0 mb0 margesection">
            ...
            <div class="">
                <ul class="reportlists">
                    ...
                    <?php }
                    if ($this->rbac->hasPrivilege('feerefund', 'can_view')) { ?>
                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/feerefund'); ?>"><a href="<?php echo base_url(); ?>report/feerefund"><i class="fa fa-file-text-o"></i> <?php echo  $this->lang->line('fees') . " " . $this->lang->line('refund') . " " . $this->lang->line('report'); ?></a>
                        </li>
                    <?php } ?>
