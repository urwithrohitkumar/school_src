            ...
            ?>
                                ...
                                <div class="text-center">
                                    ...
                                    ?>
                                        ...
                                        <div class="col-md-2 col-xs-6 systatus">
                                            ...
                                            <span class="label lbcolor"><?php echo $this->lang->line('complete') . " " . $value['complete'] . " %"; ?></span><!-- <span class="label" style="background:#cfcfcf;"><?php //echo $this->lang->line('incomplete')." ".$value['incomplete']." %";   
                                                                                                                                                                                                                    ?></span> -->
                                        </div>
                                    <?php }
                                    ?>
                ...
                <div class="box-body">
                    <div class="table-responsive" id="transfee">
                        ...
                        <div class="hide" id="visible">
                            <center><b><?php echo $this->lang->line('syllabus_status_report'); ?></b></center>
                        </div>
                        ...
                        <table class="table table-bordered topicstaus" id="headerTable">
                            <tr id="noprint">
                                <td class="pull-right"><i><?php echo $this->lang->line('note') . " : " . $this->lang->line('subject_percentage_based_on_topic'); ?></i></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <th width="100%"><?php echo $this->lang->line('subject') . " - " . $this->lang->line('lesson'); ?> - <?php echo $this->lang->line('topic'); ?>
                                    ...
                                    <span class="pull-right"><?php echo $this->lang->line('status'); ?></span>
                                </th>
                            </tr>
                            <?php
                            $s = 1;
                                            ...
                                            <li>
                                                ...
                                                ?>
                                                        <ul class="topicstaus">
                                                            ...
                                                            <li>
                                                                <h4><?php echo $l; ?> &nbsp;&nbsp;&nbsp; <?php echo $teachers_summaryvalue['name'] ?> <span><?php
                                                                ...
                                                                <ul class="topicstaus">
                                                                    ...
                                                                    ?>
                                                                        <li>
                                                                            <h5><?php echo $l . "." . $t; ?> &nbsp;&nbsp;&nbsp; <?php echo $topicsvalue['name']; ?><i><?php
