                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="fine_term_id" name="fine_term_id" class="form-control">
                                                    ...
                                                    ?>
                                                        ...
                                                        <option value="<?php echo $finetype->id ?>" <?= (set_value('fine_term_id',$feegroup_type->fine_term_id) == $finetype->id) ? "selected =selected" : '' ?>>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="mailbox-date pull-right">
                                                        <?php if ($this->rbac->hasPrivilege('fees_group_assign', 'can_view')) { ?>
                                                            <a href="<?php echo base_url(); ?>admin/feemaster/assign/<?php echo $feegroup->id ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('assign / view'); ?>">
                                                                <i class="fa fa-tag"></i>
                                                            </a>
                                                        <?php } ?>
