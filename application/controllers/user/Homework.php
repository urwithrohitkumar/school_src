...
class Homework extends Student_Controller
{
    ...
    $config = array();
    $config['upload_path']          ='./uploads/homework/assignment/';
            ...
            $message= $this->input->post('message');
             ...
             $this->load->library('upload');
                  ...
                  //  $name_array[] = $data['file_name'];
                    ...
                    $data =  array('homework_id'=>$homework_id,'student_id'=>$student_id,'message'=>$message,'docs'=>$img_name,'file_name' => $img_name);
    ...
    public function assigmnetDownload($doc)
    {
        ...
        $name     = $this->uri->segment(5);
        $ext      = explode(".", $name);
        $filepath = FCPATH. "/uploads/homework/assignment/" . $doc;
        $data     = file_get_contents($filepath);
        force_download($name, $data);
        
        //  $this->load->helper('download');
        //     force_download(FCPATH.'./uploads/homework/assignment/'.$doc, null);
    }
