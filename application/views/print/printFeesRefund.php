                        ...
                        ?>
                            ...
                            <table class="table table-striped table-responsive" style="font-size: 8pt;">
                                <thead>
                                    ...
                                    <th class=""><?php echo $this->lang->line('refund_date'); ?></th>
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        ...
                                        if (!empty($feeList->amount_detail)) {
                                            $fee_refund = json_decode(($feeList->amount_detail));

                                            foreach ($fee_refund as $fee_refund_key => $fee_deposits_value) {
                                    ...
                                    ?>
                                        <tr class="dark-gray">
                                            ...
                                            <td class="">
                                                ...
                                                <?php
                                                if ($feeList->created_at == "0000-00-00") {
                                                } else {

                                                    echo (!$feeList->created_at) ? '' : date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($feeList->created_at));
                                                }
                                                ?>
                                            </td>
                                            <td class="">
                                                ...
                                                if ($feeList->amount_detail) {
                                                    echo $this->lang->line('refund');
                                                }  ?>

                                            </td>
                                            <td class="text text-right"><?php echo $currency_symbol . $fee_paid; ?></td>

                                            <td colspan="3"><?= $feeList->receipt_number ?></td>
