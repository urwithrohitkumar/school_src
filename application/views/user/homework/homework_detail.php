            ...
            <div class="task-info task-single-inline-wrap ptt10">
               ...
               ?>
                    ...
                    <div id="fileData">
                         ...
                         <a  class="btn btn-default btn-xs" href="<?php echo base_url() . "user/homework/download/". $documentRow ?>" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('homework') . " " . $this->lang->line('documents') ?>"><i class="fa fa-download"></i>Download<small> <?= $documentRow ?></small></a>
                     &nbsp;&nbsp;&nbsp; <a  onclick="previewUserfile('<?php echo base_url() . "user/homework/download/" ?>','<?= $documentRow ?>');" >Preview <i class="fa fa-eye" aria-hidden="true"></i></a>  
...
<script>
   ...
   function previewUserfile(url,file){
         ...
         $('#myModal12345').on("hide.bs.modal", function(){
                                $('#videofile').empty();
