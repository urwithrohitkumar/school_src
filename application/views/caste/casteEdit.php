<div class="content-wrapper">  
    ...
    <section class="content">
        <div class="row">
            <?php
            if ($this->rbac->hasPrivilege('student_caste', 'can_add') || $this->rbac->hasPrivilege('student_caste', 'can_edit')) {
                ?>
                <div class="col-md-4">              
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('edit_caste'); ?></h3>
                        </div>  
                        <form action="<?php echo site_url("caste/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">   
                                <?php echo $this->customlib->getCSRF(); ?>
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('caste'); ?></label><small class="req"> *</small>
                                    <input autofocus="" id="caste" name="caste" placeholder="" type="text" class="form-control"  value="<?php echo set_value('caste', $caste['caste']); ?>" />
                    ...
                    <div class="box-body">
                        <div class="mailbox-messages table-responsive">
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        <th align="left"><?php echo $this->lang->line('caste'); ?></th>
