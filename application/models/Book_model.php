...
class Book_model extends MY_Model
{
    ...
    {
        $branch_id = $this->session->userdata['admin']['branch_id'];
        $this->datatables
            ...
            ->from('books');
        if ($branch_id != 0) {
            $this->datatables->where('books.branch_id', $branch_id);
        }
