...
class Stuattendence_model extends MY_Model
{
    ...
    public function searchAttendenceClassSection($class_id, $section_id, $date,$branch_id)
    {
        ...
        where student_session.branch_id=".$branch_id." AND  student_session.session_id=" . $this->db->escape($this->current_session) . " and student_session.class_id=" . $this->db->escape($class_id) . " and student_session.section_id=" . $this->db->escape($section_id) . ") as student_sessions   LEFT JOIN attendence_type ON attendence_type.id=student_sessions.attendence_type_id where student_sessions.student_id = students.id and students.is_active = 'yes' ORDER BY students.id ASC";
    ...
    public function searchAttendenceClassSectionPrepare($class_id, $section_id, $date,$branch_id)
    {
        ...
        WHERE student_session.branch_id=".$branch_id." AND  student_session.session_id=" . $this->db->escape($this->current_session) . " and student_session.class_id=" . $this->db->escape($class_id) . " and student_session.section_id=" . $this->db->escape($section_id) . ") as student_sessions where student_sessions.student_id=students.id ");
        return $query->result_array();
    }
