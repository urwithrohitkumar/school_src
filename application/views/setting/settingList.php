        ...
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('admin/admin/updateandappCode') ?>" method="POST" id="andapp_code">
                <div class="modal-body andapp_modal-body">
                    ...
                    <div class="form-group">
                        <label class="ainline"><span>School Android App ( <a target="_blank" href="#"> How to find it?</a> )</span></label>
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Your Email registered with Thewingshield</label>
