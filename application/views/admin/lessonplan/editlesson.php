                                ...
                                <select id="branch_id" name="branch_id" class="form-control">
                                    ...
                                    <?php  } else { ?>
                                        ...
                                        <?php foreach ($all_branch as  $value) { ?>
                                            <option value="<?php echo $value["id"] ?>" <?php if ($branch_id == $value['id']) echo "selected=selected" ?>><?php echo $value["branch_name"] ?></option>
                                    <?php }
                                    } ?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select id="secid" name="section_id" class="form-control">
                                    ...
                                    <?php foreach ($sectionlist as $section) { ?>
                                        <option value="<?php echo $section['id'] ?>" <?php if ($section_id == $section['id']) {
                                                                                            echo "selected=selected";
                            ...
                            <table class="table table-hover table-striped" id="headerTable">
                                <thead>
                                    <tr class="hide" id="visible">
                                        <td colspan="6">
                                            <center><b><?php echo $this->lang->line("lesson") . " " . $this->lang->line('list') ?></b></center>
                                        </td>
                                    </tr>
                                    <tr>
