    ...
    checksidebar();
        ...
        <div class="wrapper">
            ...
            <header class="main-header" id="alert">              
                ...
                <nav class="navbar navbar-static-top student-navbar" role="navigation">                  

                    <a onclick="collapseSidebar()" href="#" class="sidebar-toggle student-sidebar-toggle" data-toggle="offcanvas" role="button">
                    ...
                    <div class="col-lg-5 col-md-3 col-sm-2 col-xs-4">   
                        ...
                        <span href="#" class="sidebar-session student-sidebar-session">
...
if($this->studentmodule_lib->hasActive('multi_class')){
 ...
 ?>
            ...
            <aside class="main-sidebar student-main-sidebar" id="alert2">               

                <section class="sidebar">  



                    <ul class="sessionul fixedmenu student-fixedmenu">    
      ...
      <a data-toggle="modal" data-target="#user_sessionModal"><span><?php echo $this->lang->line('current_session') . ": " . $this->setting_model->getCurrentSessionName(); ?></span><i class="fa fa-pencil pull-right"></i></a>
                    ...
                    <ul class="sidebar-menu student-sidebar-menu verttop38" id="sibe-box">
