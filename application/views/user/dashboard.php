...
foreach ($unread_notifications as $notice_key => $notice_value) {
    ?>
      <div class="dashalert alert alert-success alert-dismissible" role="alert">
         <button type="button" class="alertclose close close_notice stualert" data-dismiss="alert" aria-label="Close" data-noticeid="<?php echo $notice_value->id; ?>">
            <span aria-hidden="true">&times;</span>
         </button>
         <a href="<?php echo site_url('user/notification') ?>"><?php echo $notice_value->title; ?>
         </a>
      </div>
      <?php
   }
   ...
   <div class="row">
               ...
               <div class="box box-primary student-box" >
               <div class="box-body box-profile"style="display:flex;">
                <?php if ($sch_setting->student_photo) {
                ?>
                <div class="student-img"style="flex:.3;">
            ...
            <?php }?>            
                  ...
                  <ul class="list-group list-group-unbordered student-list-item" style="flex:.6;">
         ...
         <div class="col-md-12">
            <div class="nav-tabs-custom theme-shadow">
               <ul class="nav nav-tabs student-nav">
                  <li class="active">
                    <a href="#activity" data-toggle="tab" aria-expanded="true"><?php echo $this->lang->line('profile'); ?></a>
                  </li>
               ...
               <div class="tab-content">
                  <div class="tab-pane active" id="activity">
                     <div class="tshadow mb25 bozero student-bzero">
                        <div class="table-responsive around10 pt0">
                           <table class="table table-hover table-striped student-table-stripe">
                              <tbody>
                     ...
                     <div class="tshadow mb25 bozero student-bzero">
                        ...
                        <div class="table-responsive around10 pt0">
                           <table class="table table-hover table-striped student-sec-table-stripe">
                              <tbody>
                     ...
                     <div class="tshadow mb25 bozero student-bzero">
                        ...
                        <div class="table-responsive around10 pt0">
                           <table class="table table-hover table-striped studend-third-table">
...
?>
                     <div class="tshadow mb25  bozero student-bzero">
                        ...
                        <div class="table-responsive around10 pt0">
                           <table class="table table-hover table-striped student-four-table">
                              <tbody>
