                ...
                ?>
                    ...
                    <li class="treeview <?php echo set_Topmenu('Student Information'); ?>">
                        ...
                        ?>
                            ...
                            <li class="<?php echo set_Submenu('student/disable_reason'); ?>"><a href="<?php echo base_url(); ?>admin/disable_reason"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('') . " " . $this->lang->line('disable_reason1'); ?></a></li>
                ...
                ?>
                    ...
                    <li class="treeview <?php echo set_Topmenu('Front CMS'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('home_page', 'can_view')) {

                            ?>

                                <li class="<?php echo set_Submenu('admin/front/add_home_content'); ?>"><a href="<?php echo base_url(); ?>admin/front/add_home_content"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('home_page_data'); ?></a></li>
                ...
                ?>
                    ...
                    <li class="treeview <?php echo set_Topmenu('System Settings'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('ticket', 'can_view')) {
                            ?>
                                <li class="<?php echo set_Submenu('System Settings/ticket'); ?>"><a href="<?php echo base_url(); ?>admin/ticket"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('Open_ticket_support') ?></a></li>
                            <?php
                            }
