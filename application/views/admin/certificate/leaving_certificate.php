...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            ?>
                <div class="col-md-6">  
                    <form id="fee_certificate_form" action="<?php echo base_url('Studentfee/leaving_certificate_download')?>" method="POST">                 
                    <div class="box box-primary">   
                        <div class="box-header with-border">                       
                            <h3 class="box-title"><?php echo $this->lang->line('download'); ?> <?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('leaving_certificate'); ?></h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
