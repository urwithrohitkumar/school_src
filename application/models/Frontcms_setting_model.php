...
class Frontcms_setting_model extends MY_Model {
    ...
    public function add_pagecontent($data){
        return $this->db->insert("tb_pagecontain",$data);
        

    }
    public function getHomePageData(){
        $this->db->select('*');
		$this->db->from('tb_pagecontain');
		$query = $this->db->get();
    ...
    public function  delPagecontent($id){
        $this->db->where('id', $id);
        return $this->db->delete('tb_pagecontain');
    }
    ...
    public function updatePagecontent($id,$data){
        $this->db->where('id', $id);
        $this->db->update('tb_pagecontain',$data);
        return true;
    }
    public function updatePageContentimg($data,$id){
        $this->db->where('id', $id);
        $this->db->update('tb_pagecontain',$data);
        return true;
    }
