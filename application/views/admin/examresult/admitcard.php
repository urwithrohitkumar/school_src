                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $student_value->father_name;;
                                                                ?></td>
                                                            <td><?php if(!empty($student_value->dob)) { echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($student_value->dob)); } else { echo "-"; }  ?></td>
...
<script>
    $("#branch_id").on('change', function() {
        ...
        $.ajax({
            type: "POST",
            url: base_url + "admin/examresult/optionData",
            data: {
                'branch_id': branch_id
            },
            dataType: "json",
            success: function(result) {
                ...
                var admintemplate_result = result.admintemplate_result;
                /**
                ...
                if (admintemplate_result) {
                    var html = '<option selected disabled>Select</option>';
                    for (var count = 0; count < admintemplate_result.length; count++) {
                        html += '<option value="' + admintemplate_result[count].id + '">' + admintemplate_result[count].template + '</option>';
                    }
                    $('#admitcard').html(html);
                }
            }
