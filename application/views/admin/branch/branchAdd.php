                ...
                <div class="col-md-4">
                    <div class="box box-primary" >
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('create_branch'); ?></h3>
                        </div>
                        <form id="form1" action="<?php echo site_url('admin/branch') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="branch_title" name="branch_title" placeholder="" type="text" class="form-control"  value="<?php echo set_value('branch_title'); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="branch_address" name="branch_address" placeholder="" type="text" class="form-control"  value="<?php echo set_value('branch_address'); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <?php echo $this->lang->line('active'); ?> : <input autofocus="" id="branch_status" name="branch_status" placeholder="" type="radio"  value="1" /> &nbsp;&nbsp;&nbsp;
                                    <?php echo $this->lang->line('inactive'); ?> : <input autofocus="" id="branch_status" name="branch_status" placeholder="" type="radio"  value="0" />
