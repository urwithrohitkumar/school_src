...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <form id="form1" action="<?php echo site_url('admin/front/add_home_content/update_pagecontent') ?>" enctype="multipart/form-data" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                <div class="col-md-6">
                    <!-- Horizontal Form -->
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('edit_page_content'); ?></h3>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input id="title" name="title" placeholder="" type="text" class="form-control"  required value="<?php echo $editPagedata['title'] ?>" />
                                <input id="" name="pagecontent_id" placeholder="" type="hidden" class="form-control"  require value="<?php echo $pagecontent_id ?>" />
                                <span class="text-danger"><?php echo form_error('title'); ?></span>
                            </div>

                            <div class="col-md-6 form-group">
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('add_subtitle'); ?></label><small class="req"> *</small>
                                <input id="title" name="add_subtitle" placeholder="" type="text" class="form-control"  value="<?php echo $editPagedata['add_subtitle'] ?>" required />
                            ...
                            <div class="form-group">   
                                <textarea id="editor1" name="description" placeholder="" type="text" class="form-control ss" required >
                                    <?php echo set_value('description'); ?><?php echo $editPagedata['description'] ?>
                                </textarea>   
                                <span class="text-danger"><?php echo form_error('description'); ?></span>
                            </div>   
                            <div class="box box-primary">
                            <div class="box-body">
                                <button type="submit" class="btn cfees btn-block"><i class="fa fa-save"></i> <?php echo $this->lang->line('update'); ?></button>
                            </div><!-- /.box-body -->
                        </div>                          
                        </div><!-- /.box-body -->
                    </div>
                ...
                <div class="col-md-6 col-sm-12 uploadbarfixes">
                    <div class="">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title"><?php echo $this->lang->line('update_pagecontentImage'); ?></h3>
                            ...
                            <div class="box-body">
                                ...
                                <img style="height:400px;" class="img-fluid" src="<?php echo $editPagedata['file'] ?>" alt="">
                                <form action="<?php echo site_url('admin/front/add_home_content/update_img') ?>" method="post" enctype="multipart/form-data"  method="post" accept-charset="utf-8">
                                <input id="" name="pagecontent_id" placeholder="" type="hidden" class="form-control"  require value="<?php echo $pagecontent_id ?>" />
...
$("#position option[value='<?php echo $editPagedata['position'] ?>']").attr('selected',true);
   });
   $(document).ready(function() {
$("#direction option[value='<?php echo $editPagedata['direction'] ?>']").attr('selected',true);
   });
    </script>
<script>
